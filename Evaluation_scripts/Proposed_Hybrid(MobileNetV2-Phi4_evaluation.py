...
llm_df = pd.read_csv("llm_predictions_PHI-4.csv")
        ...
        for batch in test_loader:
            ...
            for i in range(len(probs)):
                ...
                if image_path in edge_paths:
                    ...
                    # For metrics, we assume high confidence for these specific decisions
...
def plot_results(cm, y_true, y_prob, model_name):
    ...
    plt.savefig(f"{model_name.lower()}_cm_mobilenet_phi4.png", dpi=300)
    plt.close()
    ...
    plt.savefig(f"{model_name.lower()}_roc_mobilenet_phi4.png", dpi=300)
    plt.close()
